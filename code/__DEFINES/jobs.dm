...
#define JOB_DISPLAY_ORDER_SPACEPOD_PILOT 38 // SKYRAT EDIT ADDITION
#define JOB_DISPLAY_ORDER_PRISONER 39
#define JOB_DISPLAY_ORDER_CORRECTIONS_OFFICER 40 //SKYRAT EDIT ADDITON
#define JOB_DISPLAY_ORDER_NANOTRASEN_CONSULTANT 41 //SKYRAT EDIT ADDITON
