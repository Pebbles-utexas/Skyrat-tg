/obj/machinery/computer/shuttle/white_ship
	...
	shuttleId = "whiteship"
	possible_destinations = "whiteship_away;whiteship_home;whiteship_z4;whiteship_waystation;whiteship_lavaland;whiteship_custom;hugedock;largedock" //SKYRAT EDIT CHANGE
