...
/obj/machinery/power/energy_accumulator/rad_collector/process(delta_time)
	...
	if(!tank_mix.gases[/datum/gas/plasma])
		investigate_log("<font color='red'>out of fuel</font>.")
...
/obj/machinery/power/energy_accumulator/rad_collector/interact(mob/user)
	...
	investigate_log("turned [active?"<font color='green'>on</font>":"<font color='red'>off</font>"] by [key_name(user)]. [loaded_tank?"Fuel: [round(fuel/0.29)]%":"<font color='red'>It is empty</font>"].")
