...
/area/proc/ApplyDayNightTurfs()
	...
	for(var/i in day_night_adjacent_turfs)
		...
		var/mutable_appearance/appearance_to_add = mutable_appearance('modular_skyrat/modules/overmap/icons/daynight_blend.dmi', "white", DAY_NIGHT_LIGHTING_LAYER, iterated_turf, LIGHTING_PLANE, 255, RESET_COLOR | RESET_ALPHA | RESET_TRANSFORM)
