...
/datum/day_night_controller/proc/update_areas()
	...
	var/mutable_appearance/appearance_to_add = mutable_appearance('modular_skyrat/modules/overmap/icons/daynight_blend.dmi', "white", DAY_NIGHT_LIGHTING_LAYER, null, LIGHTING_PLANE, target_light, offset_const = 0)
	// (icon, icon_state = "", layer = FLOAT_LAYER, atom/offset_spokesman, plane = FLOAT_PLANE, alpha = 255, appearance_flags = NONE, offset_const)
