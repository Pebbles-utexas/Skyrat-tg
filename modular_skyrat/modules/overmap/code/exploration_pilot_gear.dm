/obj/item/clothing/under/exp_pilot
	...
	random_sensor = FALSE
	armor_type = list(MELEE = 0, BULLET = 10, LASER = 10,ENERGY = 10, BOMB = 0, BIO = 0, FIRE = 50, ACID = 40)
...
/obj/item/clothing/suit/armor/vest/exp_pilot
	...
	armor_type = list(MELEE = 20, BULLET = 30, LASER = 0, ENERGY = 10, BOMB = 40, BIO = 0, FIRE = 50, ACID = 50, WOUND = 20)
