...
//used by types of `/obj/machinery/power/shuttle_engine` and works off of magic
/datum/shuttle_extension/engine/burst
	...
	var/obj/machinery/power/shuttle_engine/our_engine

/datum/shuttle_extension/engine/burst/New(obj/machinery/power/shuttle_engine/passed_engine)
	. = ..()
...
//used by types of `/obj/machinery/power/shuttle_engine` and works off of hot atmospheric gas
