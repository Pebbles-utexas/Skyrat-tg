...
/turf/open/floor/planetary/broken_states()
	return list(base_icon_state)

/turf/open/floor/planetary/burnt_states()
	return
...
/turf/open/floor/planetary/grass/broken_states()
	return list("damaged")
...
/turf/open/floor/planetary/wasteland/broken_states()
