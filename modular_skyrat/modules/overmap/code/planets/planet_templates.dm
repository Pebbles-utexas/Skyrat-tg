...
/datum/planet_template/lavaland/SeedRuins(list/z_levels)
	...
	if (z_levels.len)
		seedRuins(z_levels, CONFIG_GET(number/lavaland_budget), list(/area/lavaland/surface/outdoors/unexplored), SSmapping.themed_ruins[ZTRAIT_LAVA_RUINS], clear_below = TRUE)
