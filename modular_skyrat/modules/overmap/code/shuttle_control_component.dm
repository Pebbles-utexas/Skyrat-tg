...
/datum/overmap_shuttle_controller/proc/ControllerClick(datum/source, atom/A, modifiers)
	SIGNAL_HANDLER
...
/datum/action/innate/open_shuttle_control/Trigger(trigger_flags)
	var/datum/overmap_shuttle_controller/OSC = target
	OSC.overmap_obj.ui_interact(OSC.mob_controller, usage_turf = OSC.control_turf)
